...
exports.expire = exports.store = void 0;
...
var expire = {
  ...
  set: function set(key, val, _ref) {
    var _ref$exp = _ref.exp,
        exp = _ref$exp === void 0 ? -1 : _ref$exp,
        _ref$read = _ref.read,
        read = _ref$read === void 0 ? -1 : _ref$read;
    var expTime = exp === -1 ? -1 : exp * (60 * 1000);
    ...
    if (expTime > 0) {
      var curStore = _store.default.get('EXPIRE_STORE') || [];
      curStore.push(key);

      _store.default.set('EXPIRE_STORE', curStore);
    }
  },
  clearForce: function clearForce() {
    var curStore = _store.default.get('EXPIRE_STORE') || [];
    ...
    _store.default.remove('EXPIRE_STORE');
  },
  clear: function clear() {
    ...
    for (var i = 0; i < curStore.length; i++) {
      ...
      var info = _store.default.get(key);
