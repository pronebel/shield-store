(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("shield-store", [], factory);
	else if(typeof exports === 'object')
		exports["shield-store"] = factory();
	else
		root["shield-store"] = factory();
})(self, function() {
...
var checkExpireViaTime = function checkExpireViaTime() {
  var info = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var key = arguments.length > 1 ? arguments[1] : undefined;

  if (info.exp !== -1 && new Date().getTime() - info.time > info.exp) {
    store__WEBPACK_IMPORTED_MODULE_0___default().remove(key);
    return null;
  }
...
var checkExpireViaRead = function checkExpireViaRead() {
  var info = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var key = arguments.length > 1 ? arguments[1] : undefined;
  ...
  if (info.read !== -1) {
    ...
    if (info.readed === info.read) {
      ...
      store__WEBPACK_IMPORTED_MODULE_0___default().set(key, info);
    }
...
var store = (store__WEBPACK_IMPORTED_MODULE_0___default());
var cache = {
  ...
  set: function set(key, val, _ref) {
    var _ref$time = _ref.time,
        time = _ref$time === void 0 ? -1 : _ref$time,
        _ref$read = _ref.read,
        read = _ref$read === void 0 ? -1 : _ref$read;
    var expTime = time === -1 ? -1 : time * 1000;
    store__WEBPACK_IMPORTED_MODULE_0___default().set(key, {
      val: val,
      exp: expTime,
    ...
    if (expTime > 0 || read > 0) {
      var curStore = store__WEBPACK_IMPORTED_MODULE_0___default().get("EXPIRE_STORE") || [];
      curStore.push(key);
      store__WEBPACK_IMPORTED_MODULE_0___default().set("EXPIRE_STORE", curStore);
    }
  },
  clearAll: function clearAll() {
    var curStore = store__WEBPACK_IMPORTED_MODULE_0___default().get("EXPIRE_STORE") || [];

    for (var i = 0; i < curStore.length; i++) {
      var key = curStore[i];
      store__WEBPACK_IMPORTED_MODULE_0___default().remove(key);
    }

    store__WEBPACK_IMPORTED_MODULE_0___default().remove("EXPIRE_STORE");
  },
  clear: function clear() {
    ...
    for (var i = 0; i < curStore.length; i++) {
      var key = curStore[i];
      var info = store__WEBPACK_IMPORTED_MODULE_0___default().get(key);
  ...
  get: function get(key) {
    ...
    var data = checkExpireViaRead(info, key);
...
//# sourceMappingURL=shield-store.js.map